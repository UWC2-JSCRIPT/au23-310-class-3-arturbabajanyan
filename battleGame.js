...
//   damagedPoints = baseDamage + Math.round(Math.random() * variableDamage);
//   defendingPlayer.health = defendingPlayer.health - damagedPoints;
//   return `${attackingPlayer.name} hits ${defendingPlayer.name} for ${damagedPoints}.`
// }
